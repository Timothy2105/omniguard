...
export default function TestEmailPage() {
  ...
  const handleSendEmail = async () => {
    try {
      ...
      setSuccess(false);
      setSending(true);
      console.log('Sending test email to authenticated user...');
    ...
    <div className="p-4 max-w-md mx-auto space-y-4">
      ...
      <div className="space-y-4">
        <div className="p-3 bg-blue-100 border border-blue-200 text-blue-700 rounded">
          ...
          <p>This will send an email to your authenticated user account. Make sure you're signed in.</p>
        </div>
        ...
        <div className="text-sm text-gray-600 mt-4">
          ...
          <ol className="list-decimal ml-5 mt-2 space-y-1">
            <li>It will send a test email to your authenticated account</li>
            <li>You must be signed in to receive the email</li>
            <li>The email will contain a dynamic verification link</li>
