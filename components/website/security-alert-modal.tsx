...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter } from '@/components/website/dialog';
...
export function SecurityAlertModal({ open, onOpenChange, onAlertComplete }: SecurityAlertModalProps) {
